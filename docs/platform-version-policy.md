...
| Alpine                  |         3.24.1 | Minimal runtime/build base, always selected by exact tag and digest. Runtime packages with released security fixes are exact-version pinned and enforced by the image vulnerability gate.                                  |
