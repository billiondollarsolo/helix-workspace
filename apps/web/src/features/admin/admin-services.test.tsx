...
describe("AdminServicesOverview admin UI", () => {
  ...
  it("renders service list rows and selected service detail from the list response", async () => {
    ...
    expect(fetchMock.mock.calls[0]?.[0]).toBe("/v1/api/admin/services");
    ...
    expect(container.textContent).toContain("/v1/api/tools/mail.send");
...
function mailService(): AdminServiceSurface {
  return {
    ...
    apiRoutes: ["/v1/api/tools/mail.send", "/v1/api/tools/mail.search"],
