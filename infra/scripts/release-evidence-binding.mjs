...
const BINDING_KEYS = ["applicationImageDigest", "schema", "webImageDigest", "workspaceSha"].sort();
const BINDING_COMPARED_FIELDS = ["workspaceSha", "applicationImageDigest", "webImageDigest"];
