...
> `docs/archive/plans/2026-07-28-core-workspace-production-readiness.md`. That plan owns
...
| `docs/archive/plans/2026-07-28-core-workspace-production-readiness.md` | Sibling plan for security/ops (on `main`)                       |
...
- Plan: docs/archive/plans/2026-08-01-shell-resilience-and-data-loss-guards.md
- Task IDs:
