...
```ts
import { describe, expect, it } from "vitest";
import { tenantConfigSchema, SYSTEM_TENANT_FEATURE_FLAGS } from "./tenant-config.js";
...
export type { TenantFeatureFlags, TenantConfig } from "@helix/contracts/tenant-config";
