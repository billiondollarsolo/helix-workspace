...
describe("assertLocalDemoVerified", () => {
  ...
  it("reports all missing seeded surfaces", () => {
    ...
    expect(verify).toThrow(
      "actor expected >= 1, got 0; Better Auth user linkage expected >= 1, got 0; Better Auth credential expected >= 1, got 0; OAuth credential expected >= 1, got 0; mail search hits expected >= 1, got 0; mail thread messages expected >= 1, got 0; docs list results expected >= 1, got 0; root Drive entries expected >= 2, got 0; project Drive entries expected >= 1, got 0; calendar events expected >= 2, got 0; chat rooms expected >= 1, got 0; chat message hits expected >= 1, got 0",
    );
