...
export const PRODUCTION_FULL_APPS_ALLOWLIST = "mail,drive,chat,assistant,calendar,meet";
export const PRODUCTION_MVP_DISABLED_MODULES = ["calendar", "meet"] as const;
