 ...
 *  same two requests.
 *
 *  `/v1/api/core-apps` is listed even though it does not fire here: this harness
...
const SHELL_REQUEST_PREFIXES = [
  "/v1/api/core-apps",
  "/v1/api/tools/notifications.unread-count",
] as const;
    ...
    expect(await measureAllSections()).toMatchInlineSnapshot(`
      {
        "agent-controls": {
          ...
          "settled": true,
          "urls": [
            "/v1/api/tools/admin.agent_controls.get",
          ],
        },
        "agent-credentials": {
          "requestCount": 2,
          "settled": true,
          "urls": [
            "/v1/api/admin/users?includeDisabled=false&limit=50",
        ...
        "app-passwords": {
          ...
          "urls": [
            "/v1/api/admin/users?includeDisabled=false&limit=50",
            "/v1/api/tools/app.passwords.list",
          ],
        },
        "audit": {
          "requestCount": 2,
          "settled": true,
          "urls": [
            "/v1/api/admin/audit-log?limit=50",
            "/v1/api/admin/users?includeDisabled=true&limit=250",
          ],
        },
        "chat": {
          "requestCount": 1,
          "settled": true,
          "urls": [
            "/v1/api/tools/chat.retention.get",
          ],
        },
        "domains": {
          "requestCount": 1,
        ...
        "drive": {
          ...
          "settled": true,
          "urls": [
            "/v1/api/tools/drive.lifecycle.get",
            "/v1/api/tools/drive.quota.usage",
          ],
        },
        "groups": {
          "requestCount": 2,
        ...
        "identity": {
          ...
          "settled": true,
          "urls": [
            "/v1/api/admin/identity/idp-configs",
          ],
        },
        "mail": {
          "requestCount": 1,
        ...
        "oauth-apps": {
          ...
          "settled": true,
          "urls": [
            "/v1/api/admin/oauth-apps?limit=50",
          ],
        },
        "overview": {
          "requestCount": 1,
        ...
        "policies": {
          ...
          "settled": true,
          "urls": [
            "/v1/api/admin/security-policies",
          ],
        },
        "services": {
          "requestCount": 1,
